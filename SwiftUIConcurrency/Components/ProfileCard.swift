...
struct ProfileCard: View {
    ...
    @State private var safariShown = false
    var body: some View {
        ...
        .offset(y: 55)
        .fullScreenCover(isPresented: $safariShown, content: {
            SFSafariViewWrapper(url: URL(string: "https://\(user.website)")!)
                .ignoresSafeArea()
        })
        .task {
            await description.update(with: "I love designing and code")
...
struct ProfileCard_Previews: PreviewProvider {
    static var previews: some View {
        ...
        let previewUser = User(id: 1, name: "Stephanie", username: "stephdiep", email: "stephanie@designcode.io", phone: "123-456-7890", website: "designcode.io", company: previewCompany, address: previewAddress)
