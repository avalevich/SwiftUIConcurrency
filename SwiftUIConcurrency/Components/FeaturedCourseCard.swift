...
struct FeaturedCourseCard: View {
    var body: some View {
        VStack(spacing: 8) {
            AsyncImage(url: URL(string: "https://images.ctfassets.net/ooa29xqb8tix/5IXFM29JvbdXKuHeGF91Y3/6b49d65577c32747b7b1a60444c56d9c/SwiftUI_Combine_800x600_cover.png")) { img in
                img.resizable()
